...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__separator__ = __webpack_require__(19);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    values: function values() {
      ...
      return this.field.value.split(__WEBPACK_IMPORTED_MODULE_0__separator__["a" /* default */]).map(function (val) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    setInitialValue: function setInitialValue() {
      ...
      if (this.field.value) {
        var selectedValues = this.field.value.split(SEPARATOR);
        this.value = selectedValues.map(function (val) {
          return _this.field.options.find(function (opt) {
    ...
    fill: function fill(formData) {
      var value = this.value && this.value.length ? this.value.map(function (v) {
        return v.value;
      }).join(SEPARATOR) : '';
